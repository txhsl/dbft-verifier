...
Find your program verification key by going into the `../script` directory and running `RUST_LOG=info cargo run --package neox-dbft-verifier-script --bin vkey --release`, which will print an output like:
